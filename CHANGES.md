...
## [4.11.0](https://github.com/Patternslib/pat-tiptap/compare/4.10.1...4.11.0) (2026-06-05)

### Features

- Allow for default to open in new window. ([9581f54](https://github.com/Patternslib/pat-tiptap/commit/9581f5449c8861b79ee41f4c9e8a0792402efae9))

    The link panel allows now to "Open in new window" to be set as default.

### Maintenance

- Fix eslint warning. ([537e249](https://github.com/Patternslib/pat-tiptap/commit/537e249c10338408e2f09ce85e533e56bf8daace))

- Makefile: Switch bundle-pre to use double-colon. ([74c4811](https://github.com/Patternslib/pat-tiptap/commit/74c48119a9e2e08c9b7778c3d21a7f0927fe599c))

    In @patternslib/dev v4 we switched to double-colon bundle-pre target so
    that the base one from @patternslib/dev is also run. This change is now
    reflected here.

- Upgrade dependencies. ([01563de](https://github.com/Patternslib/pat-tiptap/commit/01563de512bf77a8d0d9533b1f90bc10ef2668cf))

- Upgrade tiptap to 2.27.2. ([fe974a4](https://github.com/Patternslib/pat-tiptap/commit/fe974a47bb69239d29b4af11dffcb4297b578837))
