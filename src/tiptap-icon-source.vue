<template>
  <svg
      ...
      class="tiptap-icons"
  >
      <symbol viewBox="0 0 24 24" id="tiptap-icon--add_col_after">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--add_col_before">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--add_row_after">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--add_row_before">
          <path
              d="M19 14a5 5 0 110 10 5 5 0 010-10zm2.5 5.938a.937.937 0 100-1.875h-1.25a.312.312 0 01-.313-.313V16.5a.937.937 0 10-1.875 0v1.25c0 .173-.14.313-.312.313H16.5a.937.937 0 100 1.875h1.25c.173 0 .313.14.313.312v1.25a.937.937 0 101.875 0v-1.25c0-.173.14-.313.312-.313h1.25zM5 2a3 3 0 100 6h14a3 3 0 000-6H5zm0-2h14a5 5 0 010 10H5A5 5 0 115 0z"
          ></path>
      </symbol>
      <symbol viewBox="0 0 24 24" id="tiptap-icon--bold">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--combine_cells">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--delete_col">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--delete_row">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--delete_table">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--github">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--hr">
          <path d="M5 13a1 1 0 010-2h14a1 1 0 010 2H5z"></path>
      </symbol>
      <symbol viewBox="0 0 24 24" id="tiptap-icon--image">
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--italic">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--link">
          <path
          ...
          ></path>
          <path
              d="M7.757 16.241a1.011 1.011 0 001.414 0l7.779-7.778a1 1 0 00-1.414-1.414l-7.779 7.778a1 1 0 000 1.414z"
          ></path>
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--mention">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--ol">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--paragraph">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--quote">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--redo">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--remove">
          <path
              d="M20.485 3.511A12.01 12.01 0 1024 12a12.009 12.009 0 00-3.515-8.489zm-1.767 15.21A9.51 9.51 0 1121.5 12a9.508 9.508 0 01-2.782 6.721z"
          ></path>
          <path
              d="M16.987 7.01a1.275 1.275 0 00-1.8 0l-3.177 3.177L8.829 7.01a1.277 1.277 0 00-1.805 1.806l3.176 3.177-3.176 3.178a1.277 1.277 0 001.805 1.806l3.176-3.177 3.177 3.178a1.277 1.277 0 001.8-1.806l-3.176-3.178 3.176-3.177a1.278 1.278 0 00.005-1.807z"
          ></path>
      </symbol>
      <symbol viewBox="0 0 24 24" id="tiptap-icon--strike">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--table">
          <path
              fill-rule="evenodd"
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--ul">
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--underline">
          <path
      ...
      <symbol viewBox="0 0 24 24" id="tiptap-icon--undo">
          <path
